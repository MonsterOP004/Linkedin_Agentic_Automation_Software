...
const Navigation = () => {
  ...
  const navItems = [
    { path: '/', label: 'Text', component: 'text' },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="p-6 max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-900 mb-8">Content Creator</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm border-b-blue-500 p-6">
          <form onSubmit={handleSubmit} className="space-y-6">
            <Routes>
              <Route path="/" element={<TextContent handleChange={handleChange} formData={formData} />} />
